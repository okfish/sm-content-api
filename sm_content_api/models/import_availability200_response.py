...
class ImportAvailability200Response(BaseModel):
    """
    ImportAvailability200Response
    """ # noqa: E501
    data: ImportAvailability200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ImportAvailability200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
