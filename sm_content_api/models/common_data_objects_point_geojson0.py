...
class CommonDataObjectsPointGeojson0(BaseModel):
    """
    Common data object for passing location. WGS84 is used for coordinates
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommonDataObjectsPointGeojson0 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommonDataObjectsPointGeojson0 from a dict"""
        if obj is None:
            return None
