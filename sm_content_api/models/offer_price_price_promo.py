...
class OfferPricePricePromo(BaseModel):
    """
    Акционная цена товара
    """ # noqa: E501
    amount: StrictStr = Field(description="Количество (сумма)")
    currency: StrictStr = Field(description="Валюта в формате ISO-4217 (три большие буквы)")
