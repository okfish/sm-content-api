...
class PostExternalZonesCreateRequestData(BaseModel):
    """
    PostExternalZonesCreateRequestData
    """ # noqa: E501
    coordinates: Optional[List[ZoneCoordinates]] = None
    zone_id: Optional[StrictStr] = Field(default=None, description="ID зоны внутри системы Ритейлера")
    __properties: ClassVar[List[str]] = ["coordinates", "zone_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostExternalZonesCreateRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostExternalZonesCreateRequestData from a dict"""
        if obj is None:
            return None
