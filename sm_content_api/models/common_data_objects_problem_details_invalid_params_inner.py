...
class CommonDataObjectsProblemDetailsInvalidParamsInner(BaseModel):
    """
    CommonDataObjectsProblemDetailsInvalidParamsInner
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="имя поля")
    reason: Annotated[str, Field(min_length=1, strict=True)] = Field(description="текст ошибки валидации поля")
