...
class MerchantStoreStatus(BaseModel):
    """
    MerchantStoreStatus
    """ # noqa: E501
    comment: StrictStr = Field(description="Комментарий от мерчанта, по какой причине торговая точка должна находиться в этом статусе")
    scheduled_change: Optional[MerchantStoreStatusScheduledChange] = None
    ...
    __properties: ClassVar[List[str]] = ["comment", "scheduled_change", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MerchantStoreStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MerchantStoreStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scheduled_change": MerchantStoreStatusScheduledChange.from_dict(obj["scheduled_change"]) if obj.get("scheduled_change") is not None else None,
