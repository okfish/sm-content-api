...
class ImportPricesRequest(BaseModel):
    ...
    ImportPricesRequest
    """ # noqa: E501
    data: List[OfferPrice] = Field(description="Массив с данными цен товаров")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OfferPrice.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
