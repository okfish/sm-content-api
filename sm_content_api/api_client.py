...
class ApiClient:
    ...
    def param_serialize(
        ...
        :param post_params :type dict Request post form parameters,
            for `application/x-www-form-urlencoded`, `multipart/form-data`.
        :param auth_settings :type list Auth Settings names for the request.
        :param files :type dict key -> filename, value -> filepath,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sm_content_api.models, klass)
