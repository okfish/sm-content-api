...
class TestExternalZonesApi(unittest.TestCase):
    """ExternalZonesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExternalZonesApi()

    def tearDown(self) -> None:
        pass

    def test_get_store_external_zone(self) -> None:
        """Test case for get_store_external_zone

        Информация по зоне доставки для торговой точки
        """
        pass

    def test_post_external_zones_create(self) -> None:
        """Test case for post_external_zones_create

        Создание новой зоны доставки
        """
        pass

    def test_put_external_zones_update(self) -> None:
        """Test case for put_external_zones_update
